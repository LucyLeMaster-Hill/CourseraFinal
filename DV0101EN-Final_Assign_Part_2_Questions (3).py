...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        Y_chart3 = dcc.Graph(figure=px.bar(avr_data, x='Vehicle_Type', y='Automobile_Sales',title='Average Vehicles Sold by Vehicle Type in year{input_year}'))
            # Total Advertisement Expenditure for each vehicle using pie chart
    
        exp_data=yearly_data.groupby('Year')['Advertising_Expenditure'].sum().reset_index()
        Y_chart4 = dcc.Graph(figure=px.pie(pie_chart_data, values= 'Advertising_Expenditure', names= 'Vehicle_Type', title= 'Total Advertising Expenditure by Vehicle {input_year}'))
